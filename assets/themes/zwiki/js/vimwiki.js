var BYB = {};
    ...
    //if(!window.jQuery){
        //BYB.includeScript('/assets/themes/zwiki/js/jquery-1.7.2.min.js',BYB.readyFunction);
    //}else{
        //BYB.readyFunction();
    //}
    $(document).ready(function(){
        ...
        BYB.includeScript('/assets/themes/zwiki/js/prettify/prettify.js',function(){prettyPrint()});
